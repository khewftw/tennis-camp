...
function StepArrow({ flip = false }: { flip?: boolean }) {
  return (
    ...
    >
      <path
        d="M8 44c22-28 58-36 96-14 10 6 18 12 28 14"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M116 28c4 10 10 16 18 18"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M122 22l18 28-24-6"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
  ...
  return (
    <Section id="how" tone="chalk">
      <Container>
        ...
        <div className="mt-16 grid grid-cols-1 items-start gap-12 lg:mt-20 lg:grid-cols-3 lg:gap-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-3 sm:mt-16 sm:flex-row sm:flex-wrap sm:gap-4">
